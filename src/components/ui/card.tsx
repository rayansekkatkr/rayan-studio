...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => (
    <div
      ref={ref}
      className={cn(
        "rounded-3xl border border-white/80 bg-[linear-gradient(145deg,rgba(255,255,255,0.9),rgba(231,241,255,0.72))] text-slate-900 shadow-[0_26px_45px_rgba(129,158,208,0.18)] backdrop-blur-xl",
        className,
      )}
      {...props}
    />
