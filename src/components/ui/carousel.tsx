        ...
        {Array.from({ length: itemsCount }, (_, itemIndex) => (
          <button
            ...
            className={cn(
              ...
              index === itemIndex ? "bg-zinc-950 dark:bg-zinc-50" : "bg-zinc-900/50 dark:bg-zinc-100/50",
              classNameButton,
            )}
          />
        ))}
...
function CarouselContent({ children, className, transition }: CarouselContentProps) {
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver((entries) => {
      ...
      setVisibleItemsCount(Math.max(visibleCount, 1));
    }, options);
...
export { Carousel, CarouselContent, CarouselIndicator, CarouselItem, CarouselNavigation };
