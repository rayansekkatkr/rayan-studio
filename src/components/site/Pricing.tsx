...
const plansFr = [
  {
    ...
    features: [
      ...
      "2 tours de révisions inclus, livraison indicative de 1 à 2 semaines",
    ],
    featured: false,
  },
  {
    ...
    features: [
      ...
      "2 tours de révisions et suivi court après livraison, en 2 à 3 semaines indicatives",
    ],
    featured: true,
  },
  {
    ...
    name: "Sur mesure",
    price: "Devis gratuit sous 24h",
    description: "Pour un site plus complet ou une application métier sur mesure.",
    forWho: "Idéal si vous avez plusieurs pages, une administration, ou une tâche à automatiser.",
    ...
    features: [
      ...
      "Application métier : facturation, réservations, suivi, automatisation…",
      "Faisabilité validée ensemble dès le diagnostic",
      "Pages, parcours ou administration selon besoin",
...
const plansEn = [
  {
    ...
    features: [
      ...
      "2 revision rounds included, indicative delivery of 1 to 2 weeks",
    ],
    featured: false,
  },
  {
    ...
    features: [
      ...
      "2 revision rounds and a short follow-up, within 2 to 3 indicative weeks",
    ],
    featured: true,
  },
  {
    ...
    name: "Custom",
    price: "Free quote within 24h",
    description: "For a fuller website or a custom business application.",
    forWho: "Best if you need several pages, admin editing, or a task worth automating.",
    result: "You get a more complete solution aligned with your business and workflow.",
    features: [
      "Deeper audit and scoping",
      "Business application: invoicing, bookings, tracking, automation…",
      "Feasibility confirmed together at the diagnosis stage",
      "Pages, journeys or admin based on needs",
