  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-5xl">
        <p className="inline-flex rounded-none border border-[#2a231d]/14 bg-[#fffaf0]/84 px-3 py-1 text-xs font-black uppercase tracking-[0.12em] text-[#c2461f]">
          {city} • {sector}
        </p>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-[1.08fr_0.92fr]">
          <section className="rounded-none border border-[#2a231d]/14 bg-[#fffaf0]/82 p-5 shadow-[6px_6px_0_rgba(42,35,29,0.08)]">
            <p className="text-[11px] font-black uppercase tracking-[0.12em] text-[#c2461f]">Contexte local</p>
        ...
        <section className="mt-8 rounded-none border border-[#2a231d]/14 bg-[#fffaf0]/80 p-5">
          <p className="text-[11px] font-black uppercase tracking-[0.12em] text-[#6f6355]">Checklist de page locale</p>
