  ...
  const schema = {
    ...
    "@graph": [
      ...
      },
      {
        ...
        serviceType: "Création et refonte de sites vitrines premium",
        provider: { "@id": `${siteUrl}#professional-service` },
        areaServed: "France",
      },
      {
        "@type": "FAQPage",
        "@id": `${siteUrl}/a-propos-methodologie-preuves#faq`,
    ...
    <main className="min-h-screen px-4 pb-14 pt-28 md:px-8">
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <h1 className="font-display mt-5 text-4xl font-semibold text-slate-900 md:text-5xl">
          À propos / Méthodologie / Preuves
        </h1>
        <p className="mt-4 max-w-3xl text-lg text-slate-600">
          Je conçois des sites vitrines premium pour commerces locaux français. Mon objectif: clarifier l&apos;offre,
          renforcer la confiance et transformer plus de visiteurs en demandes qualifiées.
        </p>

        <section className="mt-8 rounded-3xl border border-white/85 bg-white/80 p-5 shadow-[0_20px_36px_rgba(121,156,214,0.18)]">
          <h2 className="font-display text-2xl font-semibold text-slate-900">Méthodologie</h2>
          <ul className="mt-4 space-y-2 text-sm text-slate-700">
            <li>1. Audit perception + conversion du site actuel.</li>
            <li>2. Direction visuelle premium adaptée à ton secteur.</li>
            <li>3. Refonte UX pour rendre les actions clés immédiates.</li>
            <li>4. Déploiement et suivi des signaux de conversion.</li>
          </ul>
        </section>

        <section className="mt-6 rounded-3xl border border-white/85 bg-white/80 p-5 shadow-[0_20px_36px_rgba(121,156,214,0.18)]">
          <h2 className="font-display text-2xl font-semibold text-slate-900">Preuves</h2>
          <ul className="mt-4 space-y-2 text-sm text-slate-700">
            <li>Hôtel indépendant: +41% de demandes (janvier 2026, source leads formulaires).</li>
            <li>Café de quartier: +24 messages WhatsApp (décembre 2025, export WhatsApp Business).</li>
            <li>Boulangerie artisanale: +26% de commandes/demandes traiteur (février 2026).</li>
          </ul>
        </section>

        <section className="mt-6 rounded-3xl border border-white/85 bg-white/80 p-5 shadow-[0_20px_36px_rgba(121,156,214,0.18)]">
          <h2 className="font-display text-2xl font-semibold text-slate-900">FAQ (format Q/R)</h2>
        ...
        <section className="mt-6 rounded-3xl border border-white/85 bg-white/80 p-5 shadow-[0_20px_36px_rgba(121,156,214,0.18)]">
          <h2 className="font-display text-2xl font-semibold text-slate-900">Autorité externe & cohérence</h2>
          <p className="mt-3 text-sm text-slate-700">
            Les mêmes informations de marque sont utilisées sur tout le site et dans les schémas structurés: {BRAND.name}
            , {BRAND.email}, {BRAND.phoneDisplay}, {siteUrl}.
          </p>
