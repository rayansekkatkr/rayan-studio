...
- **P0 branche `fix/legal-pages`** :
  ...
  - Reste a faire / non verifie : **aucun job de purge n'existe pour la duree de 3 ans annoncee en prospection** (a creer avant activation `SEND_ENABLED`) ; retention 14 mois a verifier dans la propriete Google Analytics 4 (Admin > Collecte et modification des donnees > Conservation des donnees). Prospection : l'utilisateur prevoit de revoir le script ; integrer la purge 3 ans a cette revision.
